...
(function () {
  ...
  const STORIES = {
    ...
    'story-2': {
      ...
      segmentImages: {
        hook:   { imageUrl: 'https://d8j0ntlcm91z4.cloudfront.net/user_37AyZ7rfikCUmAP45VFZYj00Qy3/hf_20260310_072751_1241d1cc-e870-4ab8-82eb-27d0f942348e.png', description: 'Patient Maya in bright warm dining room with large snowy windows, hair in bun, looking at camera with confident radiant smile' },
        reveal: { imageUrl: 'https://d8j0ntlcm91z4.cloudfront.net/user_37AyZ7rfikCUmAP45VFZYj00Qy3/hf_20260310_072751_516eeefe-927c-4c6b-812a-397527fa9984.png', description: 'Patient Maya in warm dining room with salad ingredients, large windows showing heavy snowfall, warm natural light' },
        demo:   { imageUrl: 'https://d8j0ntlcm91z4.cloudfront.net/user_37AyZ7rfikCUmAP45VFZYj00Qy3/hf_20260310_072752_48f2ab52-d485-4162-8175-e396f20042a3.png', description: 'Patient Maya holding MAJU COLD-PRESSED BLACK SEED OIL bottle near face, warm dining room, snowy winter landscape outside' },
        glow:   { imageUrl: 'https://d8j0ntlcm91z4.cloudfront.net/user_37AyZ7rfikCUmAP45VFZYj00Qy3/hf_20260310_072752_f40b05a0-c3f7-4478-88ed-f11372cddc9a.png', description: 'Patient Maya sitting at white counter with MAJU BLACK SEED OIL bottle prominently displayed, confident smile, snowy winter setting' },
      },
      generationPrompts: {
        hook:   'A young woman with her hair in a bun wearing a black tank top, standing in a bright warm dining room with large windows showing heavy snow falling outside. She looks directly at the camera with a confident radiant smile. On the table is a dark bottle labeled MAJU COLD-PRESSED BLACK SEED OIL with distinctive amber label. Photorealistic, warm interior lighting, winter atmosphere.',
        reveal: 'Close-up of a dark bottle labeled MAJU COLD-PRESSED BLACK SEED OIL with its distinctive amber label on a bright white marble countertop in a warm dining room. Behind the bottle, large windows show heavy snowfall outside. Warm interior lighting, morning sunlight, cozy winter setting.',
        demo:   'A young woman with her hair in a bun wearing a black tank top, drizzling dark oil from a MAJU COLD-PRESSED BLACK SEED OIL bottle onto a fresh salad in a bright dining room. Large windows behind her show heavy snow falling outside. Warm natural light, winter morning, cozy domestic scene.',
        glow:   'A young woman with her hair in a bun wearing a black tank top, holding a dark bottle labeled MAJU COLD-PRESSED BLACK SEED OIL near her face with a confident radiant smile. Bright dining room with snowy winter landscape outside. Warm golden light, radiant skin, cozy winter atmosphere.',
      },
    },
  };
...
REJECTED videos — what to avoid:\n${rejections.map((f) => `- "${f.notes}"`).join('\n') || '(none yet)'}`
  ...
  async function runRealPipeline(steps, msg, setStage) {
    ...
    if (completedVideos.length > 0 && (apiKeys.backendUrl || DEFAULT_BACKEND)) {
      ...
      const stitchOptions = { maxClipDuration: 3 };
